...
--
-- Хост: localhost
-- Время создания: Июл 27 2015 г., 16:13
...
INSERT INTO `Conference_Visitor` (`Conference_id`, `visitors_login`) VALUES
(1, 'vis'),
(1, 'vis2');
...
(4, NULL, b'0', b'0', 1, 'bitch', 2),
(5, NULL, b'0', b'0', 1, 'sadasdasdasdasdasd', 2),
(6, NULL, b'0', b'0', 1, 'HER', 2),
(7, NULL, b'0', b'0', 1, '333', 6),
(8, NULL, b'0', b'0', 1, 'zxczxv', 2);
...
--
-- Очистить таблицу перед добавлением данных `Question_Visitor`
--

TRUNCATE TABLE `Question_Visitor`;
-- --------------------------------------------------------
...
--
-- Дамп данных таблицы `ReporterRequestsSpeech`
--

INSERT INTO `ReporterRequestsSpeech` (`id`, `approved`, `reporter_login`, `speech_id`) VALUES
(1, b'0', 'rep', 2),
(2, b'1', 'rep2', 2);
...
INSERT INTO `Room` (`number`, `busy`, `capacity`, `roomOwner_login`, `isBusy`) VALUES
(200, b'0', 50, 'ro', b'0'),
(301, b'1', 10, 'ro', b'1');
...
(6, b'1', b'0', '2015-07-15 00:00:00', 'qwerty', 'QWERTY', 1, NULL, 'sp');
...
INSERT INTO `Translation` (`id`, `text`, `timestamp`, `speech_id`, `time`) VALUES
(3, 'taks-tas', '2015-04-04 10:10:10', 2, NULL);
...
('vis2', 'vis2@mail.ru', 'visitor2', '1234');
...
CREATE TABLE IF NOT EXISTS `Visitor_Question` (
  ...
  KEY `FK_7xitjnl13q11uaocjw05qqcap` (`visitorsUpVoteQuestion_login`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
